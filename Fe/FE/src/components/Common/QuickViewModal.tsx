        ...
        <div className="w-full max-w-[1100px] rounded-xl shadow-3 bg-white p-7.5 relative modal-content">
          ...
          <div className="flex flex-wrap gap-7.5">
            <div className="max-w-[526px] w-full">
              <div className="flex gap-5">
                <div className="flex flex-col gap-5">
                  {product.images?.thumbnails?.map((img, key) => (
                    <button
                  ...
                  >
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M11 0C4.92487 0 0 4.92487 0 11C0 17.0751 4.92487 22 11 22C17.0751 22 22 17.0751 22 11C22 4.92487 17.0751 0 11 0ZM11 20C6.02944 20 2 15.9706 2 11C2 6.02944 6.02944 2 11 2C15.9706 2 20 6.02944 20 11C20 15.9706 15.9706 20 11 20Z"
                        fill=""
                      />
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M11 4C11.5523 4 12 4.44772 12 5V10.5858L16.7071 15.2929C17.0976 15.6834 17.0976 16.3166 16.7071 16.7071C16.3166 17.0976 15.6834 17.0976 15.2929 16.7071L10.5858 12C10.2107 11.6249 10 11.1162 10 10.5858V5C10 4.44772 10.4477 4 11 4Z"
                        fill=""
                      />
                    </svg>
                  </button>
            ...
            <div className="max-w-[445px] w-full">
              ...
              <div className="flex items-center gap-1.5 mb-4">
                ...
                <span>
                  <span className="font-medium text-dark">
                    {product.averageRating?.toFixed(1) || 0} Đánh giá{" "}
                  </span>
                  <span className="text-dark-2">
                    ({product.reviewCount || 0} lượt đánh giá){" "}
                  </span>
                </span>
              </div>
              ...
              <div className="flex flex-wrap gap-4 mt-7.5">
                <button
