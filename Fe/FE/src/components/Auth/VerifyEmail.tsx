  ...
  return (
    <>
      ...
      <div className="max-w-[400px] mx-auto bg-white p-6 rounded shadow" style={{ marginTop: 200 }}>
        <h3 className="text-lg font-semibold mb-2 text-center">Verify Your Email</h3>
        <p className="mb-4 text-center text-sm text-gray-600">Please enter the verification code sent to your email.</p>
        <form onSubmit={handleSubmit} className={animClass}>
          ...
          {success && <div className="text-green-600 text-center mt-2">Email verified successfully!</div>}
        </form>
        <style jsx global>{`
          @keyframes shake {
